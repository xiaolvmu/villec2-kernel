...
#define MSM_TZ_DOG_BARK_REG_SAVE_PHYS	(MSM_HTC_DEBUG_INFO_PHYS + MSM_TZLOG_SIZE + MSM_WDT_PROC_INFO_SIZE + SZ_4K)	
...
#define MSM_KALLSYMS_SAVE_BASE		IOMEM(0xFEA01000)	
...
#define MSM_RTB_PHYS   0x45C00000
