...
#ifdef CONFIG_FB_MSM_HDMI_MHL
static mhl_driving_params villec2_driving_params[] = {
...
#ifdef CONFIG_FB_MSM_HDMI_MHL
	.driving_params =  villec2_driving_params,
	.driving_params_count = ARRAY_SIZE(villec2_driving_params),
#endif
};
...
static struct platform_device mipi_dsi_villec2_panel_device = {
	.name = "mipi_villec2",
	.id = 0,
};
...
int mipi_cmd_villec2_qhd_pt_init(void);

void __init villec2_init_fb(void)
{
	msm8x60_set_display_params("mipi_villec2", "hdmi_msm");
	platform_device_register(&msm_fb_device);
	platform_device_register(&mipi_dsi_villec2_panel_device);
