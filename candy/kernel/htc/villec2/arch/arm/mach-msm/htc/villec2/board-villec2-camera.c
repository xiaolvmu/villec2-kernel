...
static struct regulator *villec2_reg_8058_l10 = NULL;
static struct regulator *villec2_reg_8058_l12 = NULL;
...
static uint32_t camera_off_gpio_table[] = {
	GPIO_CFG(VILLEC2_CAM1_RSTz, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(VILLEC2_CAM2_RSTz, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(VILLEC2_CAM2_PWDN, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(VILLEC2_CAM_MCLK, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_16MA),
	GPIO_CFG(VILLEC2_CAM_I2C_SDA, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_4MA),
	GPIO_CFG(VILLEC2_CAM_I2C_SCL, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA),
	GPIO_CFG(VILLEC2_MCLK_SWITCH, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(VILLEC2_CAM_CAM1_ID, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
};

static uint32_t camera_on_gpio_table[] = {
	GPIO_CFG(VILLEC2_CAM_I2C_SDA, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_4MA),
	GPIO_CFG(VILLEC2_CAM_I2C_SCL, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA),
	GPIO_CFG(VILLEC2_CAM_MCLK, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_16MA),
	GPIO_CFG(VILLEC2_CAM1_RSTz, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(VILLEC2_CAM2_RSTz, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(VILLEC2_CAM2_PWDN, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(VILLEC2_MCLK_SWITCH, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
...
static uint32_t camera_on_gpio_table_workaround[] = {
	GPIO_CFG(VILLEC2_CAM_I2C_SDA, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_4MA),
	GPIO_CFG(VILLEC2_CAM_I2C_SCL, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_8MA),
};
#endif
...
#ifdef CONFIG_S5K3H1GX
static int villec2_s5k3h1gx_vreg_on(void)
{
	...
	if (first_run == 1) {
		...
		rc = camera_sensor_power_enable("8058_l10", 2850000, &villec2_reg_8058_l10);
		...
		rc = camera_sensor_power_enable("8058_l12", 1800000, &villec2_reg_8058_l12);
		...
		rc = camera_sensor_power_disable(villec2_reg_8058_l12);
		...
		rc = camera_sensor_power_disable(villec2_reg_8058_l10);
		if (rc < 0) {
...
static int villec2_s5k3h1gx_vreg_off(void)
{
	int rc = 0;
...
static struct msm_camera_sensor_platform_info sensor_s5k3h1gx_board_info = {
	...
	.sensor_reset	= VILLEC2_CAM1_RSTz,
};
...
static struct msm_camera_sensor_info msm_camera_sensor_s5k3h1gx_data = {
	...
	.camera_power_on = villec2_s5k3h1gx_vreg_on,
	.camera_power_off = villec2_s5k3h1gx_vreg_off,
...
static int villec2_mt9v113_vreg_on(void)
{
	...
	rc = gpio_request(VILLEC2_MCLK_SWITCH, "CAM_SEL");
	if (rc < 0)
	{
		pr_err("[CAM] GPIO (%d) request fail\n", VILLEC2_MCLK_SWITCH);
		goto init_fail;
	}
	gpio_direction_output(VILLEC2_MCLK_SWITCH, 1);
	gpio_free(VILLEC2_MCLK_SWITCH);
...
static int villec2_mt9v113_vreg_off(void)
{
	...
	gpio_direction_output(VILLEC2_MCLK_SWITCH, 0);
	gpio_free(VILLEC2_MCLK_SWITCH);
...
static struct msm_camera_sensor_platform_info sensor_mt9v113_board_info = {
	...
	.sensor_reset_enable = 1,
	.sensor_reset = VILLEC2_CAM2_RSTz,
};
