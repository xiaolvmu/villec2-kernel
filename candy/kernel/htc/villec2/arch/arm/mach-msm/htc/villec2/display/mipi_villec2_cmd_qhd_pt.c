...
static int __init mipi_cmd_villec2_qhd_pt_init(void)
{
	int ret;
	...
	ret = mipi_villec2_device_register(&pinfo, MIPI_DSI_PRIM,
...
//late_initcall(mipi_cmd_villec2_qhd_pt_init);
device_initcall_sync(mipi_cmd_villec2_qhd_pt_init);
